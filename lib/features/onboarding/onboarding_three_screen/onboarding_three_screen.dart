...
class _OnboardingThreeScreenState extends State<OnboardingThreeScreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset("assets/videos/blue.mp4")
      ..initialize().then((_) {
        setState(() {});
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Travel made simple and exciting - discover places you will love and moments you will never forget',
